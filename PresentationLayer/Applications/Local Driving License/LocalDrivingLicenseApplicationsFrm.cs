...
namespace PresentationLayer
{
    public partial class LocalDrivingLicenseApplicationsFrm : Form
    {
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            if (ApplicationStatus == "Completed" && PassTests == 3)
            {
        ...
        {
            int LocalAppID = _SelectedLDLAppID;
            ...
            ClsLicense license = ClsLicense.FindApplicationID(localDrivingLicenseApplication.ApplicationID);
        ...
        {
            int ApplicationID = _SelectedLDLAppID;
            ClsLocalDrivingLicenseApplication LocalApp = ClsLocalDrivingLicenseApplication.Find(ApplicationID); 
        ...
        private void deleteApplicationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int LocalDrivingLicenseApplicationID = _SelectedLDLAppID;
            if (MessageBox.Show("Are You Sure To Delete This Application ?", "Confirm Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
