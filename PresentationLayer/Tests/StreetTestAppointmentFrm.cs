...
{
    public partial class StreetTestAppointmentFrm : Form
    {
        public StreetTestAppointmentFrm()
        {
            InitializeComponent();
        }
        ...
        public StreetTestAppointmentFrm(int ApplicationID)
        {
        ...
        {
            DataTable AppointmentTestTable = ClsTestAppointment.GetApplicationTestAppoitmentPerTestType(_ApplicationID, 3);
        ...
        private void AddPersonBtn_Click_1(object sender, EventArgs e)
        {
            bool alreadyPassed = ClsTests.Find(_LocalDrivingLicenseApplication.LDLAppID, 3);
            if (alreadyPassed)
            {
            ...
            ScheduleTestFrm frm = new ScheduleTestFrm(_LocalDrivingLicenseApplication.LDLAppID, 3, -1);
            frm.ShowDialog();
            _LoadAppointment();
        }
        ...
        private void editToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                ScheduleTestFrm frm = new ScheduleTestFrm(_LocalDrivingLicenseApplication.LDLAppID, 3, TestAppointmentID);
                frm.ShowDialog();
                _LoadAppointment();
        ...
        private void takeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                ScheduledTestFrm frm = new ScheduledTestFrm(_LocalDrivingLicenseApplication.LDLAppID, 3, AppointmentTestID);
                frm.ShowDialog();
